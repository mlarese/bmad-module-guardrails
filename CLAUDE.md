...
| `grw` | `mlarese/bmad-module-guardrails-web` | Iris, Marea (journey, static scroll-world e video-to-scroll), Nora, Dalia, Sofia, Marco, Elio, `grl-web`, `grl-video-to-scroll`, `grl-ads`, `grl-social`, `grl-social-creative`, `grl-automation` |
